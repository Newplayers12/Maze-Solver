...
# python main.py level_2 algo1 ../../input/level_2/map3.txt



read -p "Press enter to enter Hell..."

echo Doing Level 3 maps
cd ../level_3/
python main.py level_3 algo2 ../../input/level_3/map1.txt
python main.py level_3 algo2 ../../input/level_3/map2.txt
python main.py level_3 algo2 ../../input/level_3/map3.txt
