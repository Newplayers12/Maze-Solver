...
def inSolution(start, sols):
	"""
	It returns true if the start node is in any of the solutions
	
	:param start: the starting node
	:param sols: a list of tuples, where each tuple is a solution to the problem
	:return: A list of tuples. Each tuple contains the start state and the solution path.
	"""
	for sol in sols:
		if (start in sol[1]):
			return True
